...
public class DeleteRuleConfirmPopUpController implements Initializable {
    ...
    //l'utente conferma di cancellare la regola: la regola viene effettivamente eliminata,
    //il popup viene chiuso e la card viene eliminata dalla visualizzazione
    @FXML
